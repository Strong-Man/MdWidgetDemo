...
public class BehaviorAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load(R.mipmap.ic_launcher).bitmapTransform(new RoundedCornersTransformation(this,
                90, 0)).into(head_iv);
    }
    ...
    private void loadBlurAndSetStatusBar() {
        StatusBarUtil.setTranslucent(BehaviorAct.this, StatusBarUtil.DEFAULT_STATUS_BAR_ALPHA);
        Glide.with(this).load(R.mipmap.ic_launcher).bitmapTransform(new BlurTransformation(this, 100))
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (!msg.equals("")) {
            Toast.makeText(BehaviorAct.this, msg, Toast.LENGTH_SHORT).show();
        }
